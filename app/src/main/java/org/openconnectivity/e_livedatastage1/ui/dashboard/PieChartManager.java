...
public class PieChartManager {
    ...
    private void initPieChart(){
        ...
        pieChart.setCenterText("增长率");
        pieChart.setCenterTextColor(Color.BLACK); //中间问题的颜色
        ...
        legend.setVerticalAlignment(Legend.LegendVerticalAlignment.CENTER); //中间
